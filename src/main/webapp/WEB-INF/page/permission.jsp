...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/permission.css">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/resources/js/permission.js"></script>
