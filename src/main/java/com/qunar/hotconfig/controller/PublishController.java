...
public class PublishController {
    ...
    @Autowired
    public PublishController(PublishService publishService, MailService mailService, UserService userService, DiffService diffService, ConfFileService confFileService) {
    ...
    /* 发布配置 */
    @RequestMapping(value = "/CurrentConfData/{fileId}/publish", method = { RequestMethod.POST })
    @ResponseBody
    public JsonModel publish(@PathVariable("fileId") String fileId, @CookieValue("user_info") String key) {
        ...
        // 删除配置修改记录表中对应配置的修改记录
        confFileService.deleteModifyRecordByFileId(fileId);
