...
public class ConfFileListServiceImpl implements ConfFileListService {
    ...
    private final ConfFileListDao confFileListDao;
    private final ConfFileDao confFileDao;

    @Autowired
    public ConfFileListServiceImpl(ConfFileListDao confFileListDao, ConfFileDao confFileDao) {
        this.confFileListDao = confFileListDao;
