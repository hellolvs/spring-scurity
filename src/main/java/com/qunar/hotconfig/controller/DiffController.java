...
public class DiffController {
    ...
    @Autowired
    public DiffController(DiffService diffService, UserService userService) {
        this.diffService = diffService;
        this.userService = userService;
    }

    @RequestMapping(value = "/CurrentConfData/{fileId}/diff", method = { RequestMethod.POST })
    @ResponseBody
    public JsonModel diff(@PathVariable("fileId") String fileId, @CookieValue("user_info") String key) {
